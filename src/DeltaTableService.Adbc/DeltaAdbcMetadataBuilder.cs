            ...
            foreach (AdbcInfoCode code in effectiveCodes)
            {
                ...
                switch (code)
                {
                    ...
                    case AdbcInfoCode.VendorVersion:
                        AppendString(stringBuilder, typeIdBuilder, offsetBuilder, ref stringCount, "delta-rs via DeltaTableService V3");
                        break;
                    ...
                    case AdbcInfoCode.DriverName:
                        AppendString(stringBuilder, typeIdBuilder, offsetBuilder, ref stringCount, "Microsoft.DI.DeltaTableService.Adbc");
                        break;
