...
namespace Microsoft.DI.DeltaTableService.Client.Internal
{
    ...
    /// gRPC / Arrow Flight protocol details. Implements <see cref="IDeltaTableServiceBackend"/>
    /// to provide the V1 backend for the Delta Table Service.
    /// </summary>
    internal sealed class FlightClientWrapper : IDeltaTableServiceBackend
    {
        ...
        // ------------------------------------------------------------------ //
        //  IDeltaTableServiceBackend Implementation
        // ------------------------------------------------------------------ //
