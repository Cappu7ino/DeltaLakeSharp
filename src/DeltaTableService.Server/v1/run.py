...
"""Entrypoint for the Delta Table Service Arrow Flight server."""
...
logger = logging.getLogger("DeltaTableService")


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Delta Table Service — Arrow Flight server backed by PySpark."
    )
    parser.add_argument(
        "--port",
        type=int,
