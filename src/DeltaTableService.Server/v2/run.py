...
"""Entrypoint for the Delta Table Service V2 Arrow Flight server (DataFusion)."""
...
logger = logging.getLogger("DeltaTableService.V2")


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Delta Table Service V2 — Arrow Flight server backed by DataFusion + delta-rs."
    )
    parser.add_argument(
        "--port",
        type=int,
