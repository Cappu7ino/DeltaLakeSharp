...
| write batches | Arrow C Stream | Managed stream is exported to Rust for operation duration; async insert keeps the exported stream and native storage alive until completion notification. |
