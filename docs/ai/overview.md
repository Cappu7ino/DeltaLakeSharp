...
- For V3 native operations, partition planning, JSON-result table operations, table/query/CDF/partition stream setup, and insert setup use callback-notified native async operation handles. Batch consumption and write source consumption still use Arrow C Stream ownership rules.
