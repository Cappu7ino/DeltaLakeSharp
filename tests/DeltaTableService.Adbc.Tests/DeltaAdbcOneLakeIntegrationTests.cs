...
namespace Microsoft.DI.DeltaTableService.Adbc.Tests
{
    ...
    public class DeltaAdbcOneLakeIntegrationTests
    {
        ...
        private const string PrimitiveTypesTableUri = "abfss://XingTestWorkspace@onelake.dfs.fabric.microsoft.com/XingLakehouse.Lakehouse/Tables/delta_primitive_types";
        private const string ColumnMappingTableUri = "abfss://XingTestWorkspace@onelake.dfs.fabric.microsoft.com/XingLakehouse.Lakehouse/Tables/delta_column_mapping_name";
        private const string ChangeDataTableUri = "abfss://XingTestWorkspace@onelake.dfs.fabric.microsoft.com/XingLakehouse.Lakehouse/Tables/delta_adbc_cdf_integration";
        private const string BenchmarkTableUri = "abfss://XingTestWorkspace@onelake.dfs.fabric.microsoft.com/XingLakehouse.Lakehouse/Tables/delta_bench_read_1m";
        ...
        private static X509Certificate2 FindCertificate()
        {
            ...
            if (certificate == null)
            {
                Assert.Inconclusive(
                    ...
                    "Install the PFX with private key into CurrentUser\\My or LocalMachine\\My.");
            }
