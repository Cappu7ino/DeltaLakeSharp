...
namespace Microsoft.DI.DeltaTableService.Tests
{
    ...
    public class DeltaTableServiceIntegrationTests
    {
        private static DeltaTableContainer? _container;
        private static DeltaTableServiceClient? _client;

        /// <summary>
        /// Path to the DeltaTableService directory containing the Dockerfile,
...
WHEN NOT MATCHED THEN INSERT (id, value) VALUES (s.id, s.value)";
        ...
        /// <summary>
        /// Resolves the path to the DeltaTableService.Server directory containing the Dockerfile.
        ...
        private static string GetDockerfilePath()
        {
            string assemblyDir = Path.GetDirectoryName(
                typeof(DeltaTableServiceIntegrationTests).Assembly.Location)!;
            return Path.Combine(assemblyDir, "DeltaTableService.Server");
        }
