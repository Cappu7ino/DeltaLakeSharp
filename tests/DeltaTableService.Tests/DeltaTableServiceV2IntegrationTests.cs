...
namespace Microsoft.DI.DeltaTableService.Tests
{
    ...
    [TestCategory("V2")]
    public class DeltaTableServiceV2IntegrationTests
    {
        private static DeltaTableContainer? _container;
        private static DeltaTableServiceClient? _client;

        /// <summary>
        /// Path to the DeltaTableService.Server directory containing Dockerfile.v2,
        ...
        /// <summary>
        /// Resolves the path to the DeltaTableService.Server directory containing
        ...
        private static string GetDockerfilePath()
        {
            string assemblyDir = Path.GetDirectoryName(
                typeof(DeltaTableServiceV2IntegrationTests).Assembly.Location)!;
