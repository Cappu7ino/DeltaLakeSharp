...
```powershell
dotnet run --project examples\DeltaLakeSharp.Client.Examples\DeltaLakeSharp.Client.Examples.csproj -- <optional-local-delta-table-path>
```
